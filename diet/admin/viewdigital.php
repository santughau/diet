...
if(isset($_GET['del'])){
    ...
    $del_query = "DELETE  FROM digital WHERE id = '$del_id'";
    $del_run = mysqli_query($con,$del_query);
    if($del_run)
    {
       echo "<script>alert('You have been deleted successfully')</script>";
        echo "<script>window.open('viewdigital.php','_self')</script>";  
    }
}
...
if(isset($_GET['did'])){
        ...
        $disapproved = "update digital set 
        status = 'Pending'
            ...
            <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        <div class=" table-responsive">
                            <table class="table table-bordered" id="table2excel">
                                ...
                                <tbody>
                                    <?php
                            $list = "SELECT * FROM digital  ORDER BY id DESC";
                ...
                ?>
                                    <tr class="">
                                        ...
                                        <td><a class="btn btn-primary text-white" href="schoolDetails.php?id=<?php echo $list_id;?>">Details</a></td>
                                        <td><a href="viewdigital.php?aid=<?php echo $list_id;?>" class="btn btn-primary"><i class="fa fa-check" aria-hidden="true"></i></a></td>
                                        <td><a href="viewdigital.php?did=<?php echo $list_id;?>" class="btn btn-warning"><i class="fa fa-times" aria-hidden="true"></i></a></td>
                                        <td><a href="viewdigital.php?del=<?php echo $list_id;?>" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
