                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <hr>
                                        <img src="images/post/<?php echo $post_image;?>" style="height:200px;" class="img-fluid" width="100%"><br><br>
                                        <p class="text-justify"><?php echo $post_postData;?> </p>
                                        <a href="viewpost.php" class="btn btn-secondary pull-right">GO Back</a>
                                    </div>
                                </div>
                            </div>
                       </div><hr>
