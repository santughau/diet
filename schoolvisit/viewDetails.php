...
<body>
    <div class="container-fluid">
		...
		<div class="row" style="margin-top:10px;">
            <div class="col-md-12">
            <p align="center" class="text-dark"><span>Visited By : </span><?php echo $name;?> <small>( <?php echo $pad;?>  )</small></p><hr>
               ...
               <table class="table table-bordered table-condensed " id="table2excel">
                            <tbody>
                                ...
                                <tr class="info">
                                    ...
                                    <th><?php echo $name;?> <small>( <?php echo $pad;?>  )</small></th>
                                </tr>
                                <tr class="info">
                                ...
                                <tr class="info">
                                    <th class="bg-dark text-white">तालुका </th>
                                    <th><?php echo $talukaname;?></th>
                                </tr>
                                <tr class="info">
                ...
                <div align="center">
                <button class="btn btn-primary btn-large" id="but" >Print</button>
            </div>
            </div>
        </div><hr>
