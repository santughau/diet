...
function getNavTopics(){
        global $con;
        $get_topics = "SELECT * FROM department ORDER BY dept_name asc";
        $run_topics = mysqli_query($con,$get_topics);
        while($row=mysqli_fetch_array($run_topics)){
             $topic_id = $row['dept_id'];
             $topic_title = $row['dept_name'];
             //echo "<li><a href='sort.php?topic=$topic_id'>$topic_title</a></li>";
             echo "<a class='dropdown-item' href='sort.php?d_id=$topic_id'>$topic_title</a>";
        }
}
