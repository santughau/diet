    ...
    <div class="row" style="margin-top:10px;">
        ...
        <div class="col-md-6" style="margin-bottom:15px;">
            ...
            <div class="jumbotro purple lighten-4 ">
                <p class="lead text-center">प्रश्न क्रमांक <?php echo $number;?> / <?php echo $total;?></p>
                <hr>
            </div>
            <div class="list-group">
                <h3 class="text-danger">प्रश्न </h3>
                <a href="#" class="list-group-item list-group-item-action list-group-item-danger"> <b><?php echo $question;?></b></a>
                <hr>
            </div>
            <form method="post" action="s-process.php">
                <h3 class="text-primary">खालील  पैकी  एक पर्याय  निवडा </h3>
            ...
            if ($number == $total) {
                ...
                echo 'Next';
                    ...
                    ?>" class="btn btn-primary btn-xs col-md-offset-4 col-xs-offset-4"  id="btn"></div>
