...
<div class="list-group" id="ssd">
 ...
 Dashboard</a>
  <a href="category.php" class="list-group-item list-group-item-action"> <i class="fa fa-cart-plus" aria-hidden="true"></i> इयत्ता <button type="button" class="btn btn-secondary pull-right btn-sm">
   <span class="badge badge-light text-secondary"><?php echo $row_department; ?></span></button></a>
    <a href="addexam.php" class="list-group-item list-group-item-action"> <i class="fa fa-cart-plus" aria-hidden="true"></i> विषय   <button type="button" class="btn btn-secondary pull-right btn-sm">
   ...
   <span class="badge badge-light text-secondary"><?php echo $row_users; ?></span></button></a>
    <a href="addquestion.php" class="list-group-item list-group-item-action"> <i class="fa fa-cart-plus" aria-hidden="true"></i>  प्रश्न  <button type="button" class="btn btn-secondary pull-right btn-sm">
